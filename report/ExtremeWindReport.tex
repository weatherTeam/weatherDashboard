...
\\
We now have data that are classified by date. But maybe there is multiple event during this time. We have to make clusters of stations depending of their distance between each other\\
\\
...
\\
We now have a set of cluster, each cluster representing an event. We want to extract information from these clusters.\\
\\
