...
ranges from 1975 to 2013. 

In general, and as expected, one can see a strong correlation between successive years.
It's quite often that the closest neighbor is the year before.

Table (\ref{tab:NN_jul2012}) shows the nearest neighbors for July 2012. We see here that
