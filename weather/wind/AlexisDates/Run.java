...
//		FileOutputFormat.setOutputPath(conf1, new Path("/team11/tmp/CedricAlexis_250"));
		FileOutputFormat.setOutputPath(conf1, new Path("TrieDate"));
		...
		conf2.setMapperClass(SecondSortDatesMap.class);
		conf2.setReducerClass(SecondSortDatesReducer.class);
...
//		FileInputFormat.setInputPaths(conf2, new Path("/team11/tmp/CedricAlexis_250"));
		FileInputFormat.setInputPaths(conf2, new Path("TrieDate"));
