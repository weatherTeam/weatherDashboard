...
public class TemperatureAnomalies {
	public static void main(String[] args) throws IOException {
		...
		MultipleInputs.addInputPath(temperatureAnomalies, new Path("tmp2"),
				KeyValueTextInputFormat.class);
		MultipleInputs.addInputPath(temperatureAnomalies, new Path("tmp1"),
				KeyValueTextInputFormat.class);
		...
		FileInputFormat.addInputPath(OutputTemperatureAnomalies, new Path("rawOutput"));
