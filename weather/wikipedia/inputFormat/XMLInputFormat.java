...
/**
 * A simple {@link org.apache.hadoop.mapred.InputFormat} for XML documents (
 * {@code org.apache.hadoop.mapred} API). The class recognizes begin-of-document
 * and end-of-document tags only: everything between those delimiting tags is
 * returned in an uninterpreted {@code Text} object.
 * 
 * @author Jimmy Lin
 */
public class XMLInputFormat extends TextInputFormat {
	...
	/**
	 * Simple {@link RecordReader} for XML documents (
	 * {@code org.apache.hadoop.mapred} API). Recognizes begin-of-document and
	 * end-of-document tags only: everything between those delimiting tags is
	 * returned in a {@link Text} object.
	 * 
	 * @author Jimmy Lin
	 */
	public static class XMLRecordReader implements
		...
		private static final Logger LOG = Logger
				.getLogger(XMLRecordReader.class);
			...
			if (pos < end) {
				if (readUntilMatch(startTag, false)) {
					...
					try {
						...
						// seekable (specifically, do not support
